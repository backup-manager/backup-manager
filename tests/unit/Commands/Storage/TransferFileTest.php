...
class TransferFileTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_can_create()
    {
        ...
        $transfer = new \BigName\BackupManager\Tasks\Storage\TransferFile($filesystem, 'foo', $filesystem, 'bar');
        $this->assertInstanceOf('BigName\BackupManager\Tasks\Storage\TransferFile', $transfer);
    }
    ...
    public function test_file_transfer_initiated()
    {
        ...
        $delete = new \BigName\BackupManager\Tasks\Storage\TransferFile($source, 'foo', $destination, 'bar');
        $delete->execute();
    }
}
